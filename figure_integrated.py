...
labels = ["In: {:.3g}mM; Out: {:.3g}mM".format(Cin*1e3, Cout*1e3) for Cin, Cout, Cpout in zip(All_Cin, All_Cout, All_Cpout)]
...
if len(AS) > 0:
    ...
    legend=plt.legend()
#    plt.title(folder)
    plt.savefig(os.path.join(outfolder, 'IntegratedKIO3.pdf'),bbox_inches='tight')
