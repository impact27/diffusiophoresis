...
result_gamma = pd.DataFrame(index=gamma_ps, columns=['Max', 'Inflexion'], dtype=float)
...
#%%
figure()
plt.semilogx(res.x, res.y[0], '-')
plt.twinx()
plt.plot(res.x, res.y[1], 'C1-')